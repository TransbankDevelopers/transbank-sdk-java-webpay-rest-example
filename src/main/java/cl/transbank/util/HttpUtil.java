...
public interface HttpUtil {
    ...
    String request(URL url, RequestMethod method, String query) throws IOException, WebpayException;
    String request(URL url, RequestMethod method, String query, ContentType contentType)
