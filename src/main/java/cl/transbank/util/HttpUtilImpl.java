...
public class HttpUtilImpl implements HttpUtil {
    ...
    public String request(@NonNull URL url, RequestMethod method, String query,
        ...
        try {
            ...
            System.out.println(String.format("HTTP URL : %s", url));
            System.out.println(String.format("HTTP Method : %s", method));
            if (null != headers) {
            ...
            System.out.println(String.format("HTTP Request Query : %s", query));
            switch (method) {
                case POST:
    ...
    private static String getResponseBody(InputStream responseStream) {
        try (final Scanner scanner = new Scanner(responseStream, StandardCharsets.UTF_8.name())) {
            ...
            System.out.println(String.format("HTTP Response Body : %s", responseBody));
