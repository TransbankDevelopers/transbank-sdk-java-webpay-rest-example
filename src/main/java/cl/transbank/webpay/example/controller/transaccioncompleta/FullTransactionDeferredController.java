...
public class FullTransactionDeferredController extends BaseController {
    ...
    public FullTransactionDeferredController(){
        tx = new FullTransaction(new WebpayOptions(IntegrationCommerceCodes.TRANSACCION_COMPLETA_DEFERRED, IntegrationApiKeys.WEBPAY, IntegrationType.TEST));
    }
    ...
    public ModelAndView form(
        ...
        return new ModelAndView("transaccion_completa_deferred/form", "details", details);
    }
    ...
    public ModelAndView create(
        ...
        try {
            ...
            details.put("installments-endpoint", "/transaccion_completa_deferred/installments");
        } catch (Exception e) {
            log.error("ERROR", e);
            details.put("resp", e.getMessage());
        }

        return new ModelAndView("transaccion_completa_deferred/create", "details", details);
    }
    ...
    public ModelAndView commit(@RequestParam("token") String token, HttpServletRequest request,
        ...
        try {
            ...
            addDetailModelDeferred(response, token, response.getBuyOrder(), response.getAuthorizationCode(), response.getAmount(), details);
        } catch (Exception e) {
            log.error("ERROR", e);
            details.put("resp", e.getMessage());
        }

        return new ModelAndView("transaccion_completa_deferred/commit", "details", details);
    }
    ...
    public ModelAndView installments(@RequestParam("token") String token,
        ...
        return new ModelAndView("transaccion_completa_deferred/installments", "details", details);
    }
    ...
    public ModelAndView status(@RequestParam("token_ws") String tokenWs, HttpServletRequest request) {
        ...
        return new ModelAndView("transaccion_completa_deferred/status", "details", details);
    }
    ...
    public ModelAndView refund(@RequestParam("token_ws") String tokenWs,
        ...
        return new ModelAndView("transaccion_completa_deferred/refund", "details", details);
    }
    ...
    public ModelAndView capture(@RequestParam("token_ws") String tokenWs,
        ...
        Map<String, Object> details = new HashMap<>();
        try {
            final FullTransactionCaptureResponse response = tx.capture(tokenWs, buyOrder, authorizationCode, amount);
            details.put("response", response);
        ...
        return new ModelAndView("transaccion_completa_deferred/capture", "details", details);
    }
    ...
    public ModelAndView increaseAmount(@RequestParam("token_ws") String tokenWs,
        ...
        try {
            ...
            addDetailModelDeferred(response, tokenWs, buyOrder, authorizationCode, response.getTotalAmount(), details);
        }
        catch (Exception e) {
            log.error("ERROR", e);
            details.put("resp", e.getMessage());
        }
        return new ModelAndView("transaccion_completa_deferred/increase-amount", "details", details);
    }
    ...
    public ModelAndView reverseAmount(@RequestParam("token_ws") String tokenWs,
        ...
        return new ModelAndView("transaccion_completa_deferred/reverse-amount", "details", details);
    }
    ...
    public ModelAndView increaseDate(@RequestParam("token_ws") String tokenWs,
        ...
        return new ModelAndView("transaccion_completa_deferred/increase-date", "details", details);
    }
    ...
    public ModelAndView history(@RequestParam("token_ws") String tokenWs,
        ...
        return new ModelAndView("transaccion_completa_deferred/history", "details", details);
    }
    ...
    private void addDetailModelDeferred(Object response, String tokenWs, String buyOrder, String authorizationCode, double amount, Map<String, Object> details){
        ...
        details.put("increase-endpoint", "/transaccion_completa_deferred/increase_amount");
        details.put("increase-date-endpoint", "/transaccion_completa_deferred/increase_date");
        details.put("reverse-endpoint", "/transaccion_completa_deferred/reverse");
        details.put("history-endpoint", "/transaccion_completa_deferred/history");
        details.put("resp", toJson(response));
    }
