...
<body class="container">
    ...
    OneclickMallTransactionCaptureResponse response = tx.capture(childCommerceCode, childBuyOrder, authorizationCode, amount);
                    </code>
            </pre>
        </div>
...
${details.get("resp")}
    ...
    <jsp:include page="../template/oneclick-mall-status-refund.jsp" />
