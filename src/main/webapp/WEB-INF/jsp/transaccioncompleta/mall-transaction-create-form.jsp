...
<html>
        ...
        <div class="card-body col-sm-4">
                ...
                <form id="formulario" action="/mallfulltransaction/create" method="POST">
                        ...
                        <div class="form-group">
                        <label>buyOrderTwo:</label><input name="buyOrderTwo" type="text" class="form-control" value="${model.buyOrderTwo}"/>
                        </div>
